...
#     def callback():
#         print('tocando notifiacion....')

#     layout.addWidget(QPushButton(
#         'Info', w, clicked=lambda: NotificationWindow.info('Informacion', 'Puto el que lo lea', callback=callback)))
#     layout.addWidget(QPushButton(
#         'Success', w, clicked=lambda: NotificationWindow.success('Eres Puto!', 'Felicidades lo leiste!', callback=callback)))
#     layout.addWidget(QPushButton(
#         'Warning', w, clicked=lambda: NotificationWindow.warning(
#             'Cuidado no lo leas',
#             'Al leeerlo te conviertes un puto',
#             callback=callback)))
#     layout.addWidget(QPushButton(
#         'Error', w, clicked=lambda: NotificationWindow.error(
#             'Error',
#             '<html><head/><body><p><span style=" font-style:italic; color:teal;">Que mal, no sabes leer :(, nunca sera puto</span></p></body></html>',
#             callback=callback)))
#     w.show()
